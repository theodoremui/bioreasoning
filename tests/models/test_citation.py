...
class TestCitation:
    ...
    def test_citation_creation_empty_snippet(self):
        ...
        citation = Source(
            url="https://example.com", title="Test Article", snippet="", source="pubmed"
        )
    ...
    def test_citation_with_none_values(self):
        ...
        citation = Source(url=None, title="Test", snippet="Test", source="web")
    ...
    def test_citation_empty_url(self):
        ...
        citation = Source(
            url="", title="Test Article", snippet="Test snippet", source="manual"
        )
